...
from elvira_client.api_client import ApiClient, RequestSerialized
from elvira_client.api_response import ApiResponse
from elvira_client.rest import RESTResponseType
...
class DefaultApi:
    ...
    async def get_timetable(
        ...
        :type language: str
        :param timetable_request: (required)
        :type timetable_request: TimetableRequest
        :param _request_timeout: timeout setting for this request. If one
                                 number provided, it will be total request
                                 timeout. It can also be a pair (tuple) of
                                 (connection, read) timeouts.
        ...
        _param = self._get_timetable_serialize(
            language=language,
    ...
    @validate_call
    async def get_timetable_with_http_info(
        self,
        language: StrictStr,
        timetable_request: TimetableRequest,
        _request_timeout: Union[
    ...
    @validate_call
    async def get_timetable_without_preload_content(
        self,
        language: StrictStr,
        timetable_request: TimetableRequest,
        _request_timeout: Union[
    ...
    def _get_timetable_serialize(
        ...
        # process the form parameters
        # process the body parameter
        if timetable_request is not None:
            _body_params = timetable_request
