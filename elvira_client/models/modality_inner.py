...
from elvira_client.models.modality_inner_sign import ModalityInnerSign
try:
    from typing import Self
except ImportError:
    from typing_extensions import Self

class ModalityInner(BaseModel):
    """
    ModalityInner
    """ # noqa: E501
    ...
    def from_json(cls, json_str: str) -> Self:
        """Create an instance of ModalityInner from a JSON string"""
    ...
    def from_dict(cls, obj: Dict) -> Self:
        """Create an instance of ModalityInner from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            ...
            "sign": ModalityInnerSign.from_dict(obj.get("sign")) if obj.get("sign") is not None else None,
